...
class UnibeeApiMerchantInvoiceNewReq(BaseModel):
    ...
    tax_scale: StrictInt = Field(description="TaxScale，1000 represent 10%", alias="taxScale")
    user_id: StrictInt = Field(description="UserId", alias="userId")
    __properties: ClassVar[List[str]] = ["currency", "finish", "gatewayId", "lines", "name", "taxScale", "userId"]
