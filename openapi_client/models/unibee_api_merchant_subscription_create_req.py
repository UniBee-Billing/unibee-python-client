...
class UnibeeApiMerchantSubscriptionCreateReq(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["addonParams", "confirmCurrency", "confirmTotalAmount", "gatewayId", "metadata", "paymentMethodId", "planId", "quantity", "returnUrl", "userId", "vatCountryCode", "vatNumber"]
